        ...
        <form method="post" action="success.php">
            <div class="form-group">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control text-success" id="Email" aria-describedby="emailHelp" name="emailHelp" value= "<?php echo $e;?>" disabled required>
                    <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                </div>
                <div class="mb-3">
                    <label for="phone" class="form-label">Contact Number</label>
                    <input type="number" class="form-control text-success" id="phone" aria-describedby="phoneHelp" name="phoneHelp" value= "<?php echo $c;?>" disabled required>
